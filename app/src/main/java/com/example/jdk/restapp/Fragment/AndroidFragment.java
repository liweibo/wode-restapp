...
public class AndroidFragment extends BaseFragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser) {
            RequestData.getInstance(mContext).setSHProgressinterface(this);//这里的setSHProgressinterface
             //作用是为了判断监听是否存在以及是否为一个AndroidFragment的实例 回调在BaseFragment实现。
            //去RequestData中看setSHProgressinterface的实际意义
        }
